...
public abstract class Hilt_ProductsGridFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProductsGridFragment() {
    super();
  }

  Hilt_ProductsGridFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProductsGridFragment_GeneratedInjector) this.generatedComponent()).injectProductsGridFragment(UnsafeCasts.<ProductsGridFragment>unsafeCast(this));
    }
  }
