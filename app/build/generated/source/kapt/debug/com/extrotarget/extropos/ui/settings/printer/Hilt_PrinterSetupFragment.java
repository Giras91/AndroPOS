...
public abstract class Hilt_PrinterSetupFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PrinterSetupFragment() {
    super();
  }

  Hilt_PrinterSetupFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PrinterSetupFragment_GeneratedInjector) this.generatedComponent()).injectPrinterSetupFragment(UnsafeCasts.<PrinterSetupFragment>unsafeCast(this));
    }
  }
