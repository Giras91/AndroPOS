...
public abstract class Hilt_AppLockFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AppLockFragment() {
    super();
  }

  Hilt_AppLockFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AppLockFragment_GeneratedInjector) this.generatedComponent()).injectAppLockFragment(UnsafeCasts.<AppLockFragment>unsafeCast(this));
    }
  }
