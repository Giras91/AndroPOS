...
public abstract class Hilt_PosFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PosFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PosFragment_GeneratedInjector) this.generatedComponent()).injectPosFragment(UnsafeCasts.<PosFragment>unsafeCast(this));
    }
  }
