...
public class ItemCartBindingImpl extends ItemCartBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.decreaseButton, 2);
        sViewsWithIds.put(R.id.quantityTextView, 3);
        sViewsWithIds.put(R.id.increaseButton, 4);
        sViewsWithIds.put(R.id.unitPriceTextView, 5);
        sViewsWithIds.put(R.id.totalPriceTextView, 6);
