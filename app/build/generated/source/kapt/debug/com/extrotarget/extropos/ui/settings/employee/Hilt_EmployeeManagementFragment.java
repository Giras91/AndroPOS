...
public abstract class Hilt_EmployeeManagementFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EmployeeManagementFragment() {
    super();
  }

  Hilt_EmployeeManagementFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EmployeeManagementFragment_GeneratedInjector) this.generatedComponent()).injectEmployeeManagementFragment(UnsafeCasts.<EmployeeManagementFragment>unsafeCast(this));
    }
  }
