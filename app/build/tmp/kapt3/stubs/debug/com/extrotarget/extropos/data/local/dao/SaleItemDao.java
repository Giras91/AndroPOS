...
public abstract interface SaleItemDao {
    ...
    @androidx.room.Query(value = "SELECT * FROM sale_items WHERE saleId IN (:saleIds)")
    @org.jetbrains.annotations.Nullable()
    public abstract java.lang.Object getItemsBySaleIds(@org.jetbrains.annotations.NotNull()
    java.util.List<java.lang.String> saleIds, @org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super java.util.List<com.extrotarget.extropos.data.local.entity.SaleItemEntity>> $completion);
