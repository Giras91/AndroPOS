...
public abstract interface OrderItemDao {
    ...
    @androidx.room.Query(value = "DELETE FROM order_items WHERE orderId = :orderId AND id = :itemId")
    @org.jetbrains.annotations.Nullable()
